...
import { FileText, Plus, History, BookOpen, Settings, Sparkles, Circle } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <aside className="w-full md:w-64 bg-slate-900 text-slate-300 flex flex-col md:min-h-screen border-r border-slate-800 shrink-0">
